            ...
            <div className={' max-w-[1440px] h-[80vh]  w-full m-auto'}>
                <div className={'z-50 flex sm:flex-wrap mymc-con'}>
                    ...
                    <motion.div
                        ...
                        <h1 className={'text-[71px] font-bold head-font  text-white'}>
                            <span className={'mine-logo text-[#0eff00] '}>MYMC</span> SERVER</h1>
                        <p className={'text-[16px] mb-4  w-[600px] text-left text-[#ADB7BE]'}>Welcome to MYMC (Muttayi
                            Minecraft) – Kerala’s top public Minecraft server where creativity meets adventure! Whether
                            you're a builder, an explorer, or a fierce competitor, our server offers an exciting
                            survival, minigames, and custom gameplay experience. Connect with fellow Malayali gamers,
                            participate in thrilling events, and enjoy a lag-free, community-driven Minecraft
                            world. </p>
